...
export default function Footer() {
  return (
    <footer className="relative  w-full  z-10 bg-white pt-20 pb-10 lg:pt-[120px] border-t-2 border-gray-200 overflow-hidden lg:pb-20">
      <div className="container w-[90%] px-6 py-3 mx-auto">
        <div className="flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a className="mb-2 inline-block text-base leading-loose text-body-color hover:text-primary">
                    SaaS Development
                  </a>
                </li>
                <li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <a className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-red-400 sm:mr-4 lg:mr-3 xl:mr-4">
                  <svg
                    width="8"
                    height="16"
                    viewBox="0 0 8 16"
