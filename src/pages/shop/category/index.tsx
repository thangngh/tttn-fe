...
export default function Category() {
  ...
  return (
    <ShopLayout>
      <div className="h-full w-4/5  overflow-x-auto mx-auto  my-4 p-4 space-y-4">
        <DrawerHeader />
        <div className="flex items-baseline container  mx-auto justify-between border-b border-gray-200">
